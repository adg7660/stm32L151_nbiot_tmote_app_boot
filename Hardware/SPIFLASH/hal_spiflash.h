...
/* APP3 FLASH ADDRESS TABLE */
#define APP3_BASE_ADDR							0x080000U
#define APP3_BYTE_SIZE							0x040000U
#define APP3_INFORMATION_ADDR						APP3_BASE_ADDR
#define APP3_INFORMATION_SIZE						0x1000
#define APP3_DATA_ADDR							APP3_BASE_ADDR + APP3_INFORMATION_SIZE
#define APP3_DATA_SIZE							APP3_BYTE_SIZE - APP3_INFORMATION_SIZE
#define APP3_INFO_UPGRADE_STATUS_OFFSET				APP3_INFORMATION_ADDR
#define APP3_INFO_UPGRADE_STATUS_LENGTH				1														//升级标志 高4位0x5(0101)有升级包 低4位0x5(0101)可升级
#define APP3_INFO_UPGRADE_BASEADDR_OFFSET			APP3_INFO_UPGRADE_STATUS_OFFSET + APP3_INFO_UPGRADE_STATUS_LENGTH
#define APP3_INFO_UPGRADE_BASEADDR_LENGTH			4														//升级APP起始地址
#define APP3_INFO_UPGRADE_BLOCKNUM_OFFSET			APP3_INFO_UPGRADE_BASEADDR_OFFSET + APP3_INFO_UPGRADE_BASEADDR_LENGTH
#define APP3_INFO_UPGRADE_BLOCKNUM_LENGTH			2														//升级APP存放块数
#define APP3_INFO_UPGRADE_BLOCKLEN_OFFSET			APP3_INFO_UPGRADE_BLOCKNUM_OFFSET + APP3_INFO_UPGRADE_BLOCKNUM_LENGTH
#define APP3_INFO_UPGRADE_BLOCKLEN_LENGTH			2														//升级APP块长度
#define APP3_INFO_UPGRADE_DATALEN_OFFSET			APP3_INFO_UPGRADE_BLOCKLEN_OFFSET + APP3_INFO_UPGRADE_BLOCKLEN_LENGTH
#define APP3_INFO_UPGRADE_DATALEN_LENGTH			2														//升级APP块有效长度
#define APP3_INFO_UPGRADE_INDEX_OFFSET				APP3_INFO_UPGRADE_DATALEN_OFFSET + APP3_INFO_UPGRADE_DATALEN_LENGTH
#define APP3_INFO_UPGRADE_INDEX_LENGTH				4														//升级APP序号
#define APP3_INFO_UPGRADE_SOFTVER_OFFSET			APP3_INFO_UPGRADE_INDEX_OFFSET + APP3_INFO_UPGRADE_INDEX_LENGTH
#define APP3_INFO_UPGRADE_SOFTVER_LENGTH			4														//升级包版本号 高2字节主版本号 低2字节从版本号
#define APP3_INFO_DOWNLOAD_TIME_OFFSET				APP3_INFO_UPGRADE_SOFTVER_OFFSET + APP3_INFO_UPGRADE_SOFTVER_LENGTH
#define APP3_INFO_DOWNLOAD_TIME_LENGTH				4														//升级包下载时间
/* END APP3 ADDRESS TABLE */
